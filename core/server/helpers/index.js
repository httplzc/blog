...
coreHelpers.length = require('./length');
coreHelpers.tag_cloud = require('./tag_cloud');
coreHelpers.commentPager = require('./commentPager');
coreHelpers.equal = require('./equal');
...
registerHelpers = function (adminHbs) {
	...
	registerThemeHelper('equal', coreHelpers.equal);
	registerThemeHelper('commentPager', coreHelpers.commentPager);
