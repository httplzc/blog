...
var _           = require('lodash'),
	...
	put_data_format=require('../../extra_api/put_data_format'),
...
function renderPost(req, res) { 
    return function renderPost(post) {
		...
		put_data_format.addExtraData(sessionId,response,function(data){ 
			 res.render(view,data);
		},response.post.author.id,response.post.id);
        ...
        return fetchData(channelOpts).then(function handleResult(result) {
            ...
            filters.doFilter('prePostsRender', result.posts, res.locals).then(function then(posts) {
               ...
               //res.render(view, result);
				put_data_format.addExtraPostData(result,function(data){
					res.render(view, data);
				});
            });
