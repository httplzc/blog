...
config = {
    ...
    production: {
       url: 'http://www.lizechao.com',
	
       mail: {
		transport: 'SMTP',
		from: '466144725@qq.com',
		options: {
        service: 'QQ',
			auth: {
				user: '466144725@qq.com',
				pass: 'upwnqstbnjukcajc'
			}
			} 
		},
       /* database: {
    ...
    development: {
        ...
        service: 'Mailgun',
			auth: {
				user: 'postmaster@mail.lizechao.com',
				pass: 'mailgunlzc62825179'
			}
			} 
		},
